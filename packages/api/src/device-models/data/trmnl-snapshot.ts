// Generated by scripts/update_device_model_snapshot.mjs from https://usetrmnl.com/api on 2026-08-22.
...
export const TRMNL_PALETTES_SNAPSHOT: TrmnlPalettePayload[] = [
  {
    id: 'bw',
...
export const TRMNL_MODELS_SNAPSHOT: TrmnlModelPayload[] = [
  {
    name: 'v2',
    label: 'TRMNL X',
    description: 'TRMNL X',
  ...
  {
    name: 'waveshare_5_8_bw',
    label: 'Waveshare 5.83" (Steam Machine)',
    description: 'Waveshare 5.83" (Steam Machine)',
    width: 648,
    height: 480,
    colors: 4,
    bit_depth: 2,
    ...
    css: {
      classes: {
        device: 'screen--waveshare_5_8_bw',
        size: 'screen--md',
        density: 'screen--density-1x',
      },
      variables: [
  ...
  {
    name: 'inkplate_13_spectra',
    label: 'Inkplate 13 Spectra',
    description: 'Inkplate 13 Spectra',
    width: 1600,
    height: 1200,
    colors: 2,
    bit_depth: 1,
    ...
    css: {
      classes: {
        device: 'screen--inkplate_13_spectra',
        size: 'screen--md',
        density: 'screen--density-2x',
      },
      variables: [
  ...
  {
    name: 'tcl_nxtpaper_14',
    label: 'TCL NxtPaper 14',
    description: 'TCL NxtPaper 14',
    width: 2400,
    height: 1600,
    colors: 16777216,
    bit_depth: 24,
