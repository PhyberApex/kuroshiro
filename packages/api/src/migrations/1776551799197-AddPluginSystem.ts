...
export class AddPluginSystem1776551799197 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "screen" ADD COLUMN IF NOT EXISTS "cachedPluginOutput" text`)
    await queryRunner.query(`ALTER TABLE "screen" ADD COLUMN IF NOT EXISTS "devicePluginId" uuid`)
    await queryRunner.query(`ALTER TABLE "screen" ADD COLUMN IF NOT EXISTS "pluginId" uuid`)
    await queryRunner.query(`ALTER TABLE "device" ALTER COLUMN "lastSeen" SET DEFAULT '"2026-04-18T22:36:39.653Z"'`)
    await queryRunner.query(`ALTER TABLE "log_entry" DROP CONSTRAINT IF EXISTS "FK_279159e616ea17eba352e988242"`)
    ...
    await queryRunner.query(`ALTER TABLE "screen" DROP CONSTRAINT IF EXISTS "FK_6cb4f31b6d941025f95573be999"`)
    ...
    await queryRunner.query(`ALTER TABLE "screen" DROP CONSTRAINT IF EXISTS "FK_dc49b148393f4373e0d0b9b451d"`)
    ...
    await queryRunner.query(`ALTER TABLE "device_plugin" DROP CONSTRAINT IF EXISTS "FK_bcf332253aeef61ec3982b06f95"`)
    ...
    await queryRunner.query(`ALTER TABLE "device_plugin" DROP CONSTRAINT IF EXISTS "FK_ab6ecea6cb905626e4d87fd102c"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_data_source" DROP CONSTRAINT IF EXISTS "FK_42ab897c74fe88f343a4126904c"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_field" DROP CONSTRAINT IF EXISTS "FK_ab61301d6a24662aae07b592ea7"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_field_value" DROP CONSTRAINT IF EXISTS "FK_3aaef93d5e372ce9ec1ebb6635e"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_field_value" DROP CONSTRAINT IF EXISTS "FK_4ac249bde6572aaa58d9d7855c5"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_field_value" DROP CONSTRAINT IF EXISTS "FK_671695a8c46f9825c315b60e542"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_template" DROP CONSTRAINT IF EXISTS "FK_5f773f5720e2de7f9228c7b24f2"`)
    ...
    await queryRunner.query(`ALTER TABLE "plugin_variable" DROP CONSTRAINT IF EXISTS "FK_689c467e58b8f28cc10cd8cacc8"`)
